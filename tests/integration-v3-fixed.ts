/**
 * Integration Test Suite for V3 Cloud Edition (Fixed)
 */
...
// @ts-ignore
import { SQLiteProvider } from '../src/core/storage/sqlite-provider.js';
// @ts-ignore
import { SupabaseProvider } from '../src/core/storage/supabase-provider.js';
// @ts-ignore
import { ConversationItem } from '../src/core/storage/types.js';
...
class TestableSupabaseProvider extends SupabaseProvider {
  constructor(local: SQLiteProvider, url: string, key: string) {
    super(local, url, key);
    // Inject Mock
